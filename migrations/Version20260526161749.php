 ...
 */
final class Version20260526161749 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE users ADD id INT AUTO_INCREMENT NOT NULL, ADD roles JSON NOT NULL, ADD is_verified TINYINT NOT NULL, CHANGE email email VARCHAR(180) NOT NULL, CHANGE password password VARCHAR(255) NOT NULL, CHANGE fullname username VARCHAR(50) NOT NULL, DROP PRIMARY KEY, ADD PRIMARY KEY (id)');
        $this->addSql('ALTER TABLE users RENAME INDEX email TO UNIQ_IDENTIFIER_EMAIL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `users` DROP id, DROP roles, DROP is_verified, CHANGE email email VARCHAR(100) DEFAULT \'NULL\', CHANGE password password VARCHAR(255) DEFAULT \'NULL\', CHANGE username fullname VARCHAR(50) NOT NULL, DROP PRIMARY KEY, ADD PRIMARY KEY (fullname)');
        $this->addSql('ALTER TABLE `users` RENAME INDEX uniq_identifier_email TO email');
    }
}
